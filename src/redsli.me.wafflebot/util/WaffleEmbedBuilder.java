 ...
 */
public class WaffleEmbedBuilder {

    public WaffleEmbedBuilder withUserFooter(MessageEvent event) {
        return withUserFooter(event.getAuthor(), event.getGuild());
    }

    public WaffleEmbedBuilder withUserFooter(IUser user, IGuild guild) {
        withFooterText("Requested by " + user.getName());
        if(guild != null)
            if(user.getNicknameForGuild(guild) != null)
                withFooterText("Requested by " + user.getNicknameForGuild(guild));
     ...
     */
    public WaffleEmbedBuilder setLenient(boolean lenient) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withTitle(String title) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withDescription(String desc) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withDesc(String desc) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder appendDescription(String desc) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder appendDesc(String desc) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withTimestamp(Instant instant) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withTimestamp(long millis) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withColor(Color color) {
        this.color = color;
        return this;
    }
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withColor(int color) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withColor(int r, int g, int b) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withFooterText(String footer) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withFooterIcon(String iconUrl) {
        if(embed.footer == null)
            embed.footer = new EmbedObject.FooterObject(null, null, null);
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withImage(String imageUrl) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withThumbnail(String url) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withAuthorIcon(String url) {
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withAuthorName(String name) {
        if(embed.author == null)
            embed.author = new EmbedObject.AuthorObject(null, null, null, null);
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withAuthorUrl(String url) {
        if(embed.author == null)
            embed.author = new EmbedObject.AuthorObject(null, null, null, null);
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder withUrl(String url) {
        embed.url = url;
        return this;
    }
     ...
     */
    public WaffleEmbedBuilder appendField(String title, String content, boolean inline) {
     ...
     */
    public WaffleEmbedBuilder appendField(IEmbed.IEmbedField field) {
        if(field == null) {
            if(lenient)
                return this;
            else
     ...
     * @return The builder instance.
     */
    public WaffleEmbedBuilder clearFields() {
        fields.clear();
        return this;
    }
